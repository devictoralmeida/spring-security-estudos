...
//    });
    ...
    http.oauth2ResourceServer(resourceServerConfig -> resourceServerConfig.jwt(jwtConfigurer -> jwtConfigurer.jwtAuthenticationConverter(jwtAuthenticationConverter)));
...
//    CustomAuthenticationProviderProd customAuthenticationProvider = new CustomAuthenticationProviderProd(userDetailsService, passwordEncoder);
